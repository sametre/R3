...
public static class PermissionCatalog
{
    ...
    [
        ...
        "edocuments.view", "edocuments.generate", "edocuments.payload.view", "edocuments.invoice.send", "edocuments.archive.send", "edocuments.despatch.send", "edocuments.status.query", "edocuments.retry", "edocuments.cancel", "edocuments.incoming.view", "edocuments.incoming.import", "edocuments.settings.view", "edocuments.settings.edit", "edocuments.audit.view",
