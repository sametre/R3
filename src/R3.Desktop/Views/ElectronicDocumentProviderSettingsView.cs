...
internal static class ElectronicDocumentProviderSettingsView
{
    public static UIElement Create(StoreDatabase database, string companyId)
    {
        ...
        header.Children.Add(new TextBlock { Text = "E-Belge Ayarları", FontSize = Ui.Font.Kpi, FontWeight = FontWeights.SemiBold, Foreground = Ui.Brush("R3.Text.Primary.Brush") });
        ...
        var card = new Border { Background = Ui.Brush("R3.Surface.Brush"), BorderBrush = PanelBorder, BorderThickness = new Thickness(1), CornerRadius = new CornerRadius(7), Padding = new Thickness(16) };
        ...
        form.Children.Add(new TextBlock { Text = "Sağlayıcı", Foreground = Muted, FontSize = Ui.Font.Caption, Margin = new Thickness(0, 10, 0, 4) });
        ...
        form.Children.Add(new TextBlock { Text = "Ortam", Foreground = Muted, FontSize = Ui.Font.Caption, Margin = new Thickness(0, 10, 0, 4) });
        ...
        void Refresh()
        {
            ...
            status.Foreground = vm.ErrorMessage != null ? Ui.Brush("R3.Danger.Brush") : Ui.Brush("R3.Success.Brush");
            ...
            if (vm.HealthMessage != null)
            {
                ...
                healthPanel.Background = vm.LastHealthy == true ? Ui.Brush("R3.Success.Soft.Brush") : vm.LastHealthy == false ? Ui.Brush("R3.Danger.Soft.Brush") : Ui.Brush("R3.Surface.Alt.Brush");
                healthText.Foreground = vm.LastHealthy == true ? Ui.Brush("R3.Text.Primary.Brush") : vm.LastHealthy == false ? Ui.Brush("R3.Danger.Brush") : Ui.Brush("R3.Text.Secondary.Brush");
            }
    ...
    {
        parent.Children.Add(new TextBlock { Text = label, Foreground = Muted, FontSize = Ui.Font.Caption, Margin = new Thickness(0, 0, 0, 4) });
        var box = new TextBox { Text = value, IsReadOnly = true, Height = 30, Background = Ui.Brush("R3.Surface.Alt.Brush") };
