...
internal static class ElectronicDocumentGenericDetailView
{
    public static UIElement Create(StoreDatabase database, string electronicDocumentId)
    {
        ...
        header.Children.Add(new TextBlock { Text = document.DocumentNumber ?? document.Uuid, FontSize = 20, FontWeight = FontWeights.SemiBold, Foreground = Brush("263746") });
        ...
        panel.Children.Add(new Border { Background = Brushes.White, BorderBrush = PanelBorder, BorderThickness = new Thickness(1), CornerRadius = new CornerRadius(7), Padding = new Thickness(16), Child = grid });
